(() => {
    ...
    i.n = e => {
        ...
        function d() {
            ...
            return "game-cdn.poki.com" === t || t.endsWith(".github.io"), !1
        }
        var A = {
                adTagUrl: "",
                adTiming: {
        ...
        h.endsWith("github.io") && (h = "github.io");
